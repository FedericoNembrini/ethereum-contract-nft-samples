 ...
 * @author Federico Nembrini
 */
contract SampleContract is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public SellPrice = 0.015 ether;
    ...
    constructor(
        ...
        address beneficiary,
        address royalties
    ) ERC721("SampleNFTContract", "SNFTC") {
